...
export const metadata: Metadata = {
  title: "Garant Snus - Authentic Snus Experience",
  description: "Discover the finest snus crafted with tradition and quality.",
  keywords: "snus, tobacco, traditional, quality, Garant",
  openGraph: {
    title: "Garant Snus - Authentic Snus Experience",
    description: "Discover the finest snus crafted with tradition and quality.",
    url: "https://www.garantsnus.com",
    siteName: "Garant Snus",
    images: [{ url: "https://images.pexels.com/photos/5760878/pexels-photo-5760878.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website",
  },
  twitter: {
    ...
    title: "Garant Snus - Authentic Snus Experience",
    description: "Discover the finest snus crafted with tradition and quality.",
    images: ["https://images.pexels.com/photos/5760878/pexels-photo-5760878.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: {
    index: true,
    follow: true,
